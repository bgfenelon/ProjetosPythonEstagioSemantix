...
class RemovaStopWords:

    def remova_stopwords(self, txt):
        ...
        texto = texto.lower()
        listaPalavrasStopWords = ['eram', 'mesmo', 'tenha', 'nossos', 'nas', 'sejamos', 'aquele', 'meus', 'mais',
                                  'pelo',
                                  ...
                                  'às', 'à', 'estivermos', 'do', 'esses', 'estavam', 'por', 'pelos', 'dele', 'há',
                                  'como',
                                  'na', 'houvemos', 'tivermos', 'as', 'seria', 'tiver', 'estiveram', 'eles', 'das',
                                  'sem',
                                  'foi', 'temos', 'lhes', 'terá', 'tua', 'tivemos', 'ela', 'era', 'teu', 'aos', 'num',
                                  'seus', 'estejam', 'ou', 'hajam', 'dela', 'quando', 'houvéramos', 'tinham',
                                  'seríamos',
                                  ...
                                  'estava', 'hei', 'fossem', 'que', 'com', 'estão', 'éramos', 'entre', 'quem',
                                  'houverem',
                                  'fui', 'estivera', 'os', 'da', 'houvéssemos', 'teríamos', 'é', 'em', 'estas',
                                  'depois',
                                  'estamos', 'no', 'o', 'for', 'houverão', 'delas', 'nós', 'seja', 'fosse', 'serei',
                                  'estivesse', 'tu', 'houvera', 'não', 'sou', 'aquela', 'houver', 'isso', 'está',
                                  'tiveram',
                                  'teriam', 'tivéssemos', 'esse', 'a', 'estou', 'havemos', 'houvesse', 'nossa',
                                  'estive',
